...
export const tools: ToolMeta[] = [
  ...
  },
  {
    ...
    status: "ready",
    priority: 7,
    description: "붙여넣은 글의 전체 글자, 공백 제외 글자, 단어, 줄, 바이트 수를 확인합니다.",
    cardDescription: "글자 수, 공백 제외, 단어, 줄 수를 바로 확인합니다.",
    useCase: "자기소개서, 안내문, 문자, 판매글을 제출하거나 올리기 전에 길이를 맞출 때 씁니다.",
    badges: ["바로 계산", "브라우저 처리"],
    cta: "글자수 세기",
    tags: ["글자수", "단어", "바이트", "문서"],
    features: ["글자수", "단어", "바이트"],
    privacyNote: "입력한 글은 글자 수를 계산하기 위해 서버로 보내지 않습니다.",
    relatedTools: ["privacy-masker", "used-market-writer"],
    relatedGuides: ["used-market-title-examples", "online-submit-privacy-checklist"],
    featured: false,
    related: ["privacy-masker", "used-market-writer"],
    faqs: [...baseFaqs, "바이트 수는 어떤 기준인가요?"],
    sections: ["사용 예시", "알아둘 점"]
  },
  {
    id: "date-calculator",
    ...
    status: "ready",
    priority: 8,
    description: "두 날짜 사이의 차이와 기준일에서 며칠 뒤 날짜를 계산합니다.",
    cardDescription: "날짜 차이와 며칠 뒤 날짜를 계산합니다.",
    useCase: "신청 마감, 여행 일정, 이사 날짜, 보증 기간처럼 날짜 차이를 빠르게 확인할 때 씁니다.",
    badges: ["날짜 차이", "브라우저 처리"],
    cta: "날짜 계산하기",
    tags: ["날짜", "계산", "마감", "일정"],
    features: ["날짜", "일수", "일정"],
    privacyNote: "입력한 날짜는 브라우저에서 계산합니다.",
    relatedTools: ["character-counter", "document-packager"],
    relatedGuides: ["moving-before-checklist", "travel-checklist-make"],
    featured: false,
    related: ["character-counter", "document-packager"],
    faqs: [...baseFaqs, "날짜 차이는 어떻게 계산하나요?"],
    sections: ["사용 예시", "알아둘 점"]
  },
  {
    id: "fair-random",
    ...
    name: "공정 추첨",
    shortName: "추첨",
    route: "/tools/fair-random",
    path: "/tools/fair-random",
    category: "기타",
    status: "ready",
    priority: 9,
    description: "참가자 이름을 입력해 당첨자나 발표 순서를 무작위로 뽑습니다.",
    cardDescription: "참가자 목록에서 당첨자나 순서를 뽑습니다.",
    useCase: "모임, 수업, 이벤트에서 발표 순서나 당첨자를 빠르게 정할 때 씁니다.",
    badges: ["중복 제거", "결과 표시"],
    cta: "추첨하기",
    tags: ["추첨", "랜덤", "발표", "모임"],
    features: ["추첨", "랜덤", "목록"],
    privacyNote: "참가자 목록은 브라우저에서만 사용합니다.",
    relatedTools: ["date-calculator", "character-counter"],
    relatedGuides: ["used-market-title-examples", "moving-before-checklist"],
    featured: false,
    related: ["date-calculator", "character-counter"],
    faqs: [...baseFaqs, "중복 이름은 어떻게 처리하나요?"],
    sections: ["사용 예시", "알아둘 점"]
  },
  {
